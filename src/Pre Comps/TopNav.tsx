...
export const TopNav : React.FC<TopNavPropType> = ({searchSetter}) => {
    return (
        <>
            <div className="flex mb-3 items-center justify-between">
                <div className="flex gap-5 justify-center items-center">
                    ...
                    <input type="text" placeholder="Search" className="border w-[350px] h-[40px] px-5 rounded-full hidden lg:block" onChange={(e) => searchSetter(e.target.value)} />
                </div>
            ...
            <input type="text" placeholder="Search" className="border h-[40px] px-5 rounded-full block lg:hidden mb-4 w-[100%]" onChange={(e) => searchSetter(e.target.value)}/>
        </>
    )
}